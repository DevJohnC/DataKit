...
namespace DataKit.ORM.Sql.QueryBuilding
{
		...
		where TEntity : class
	{
		...
		IWhereQueryBuilder<TEntity> AndWhere<TValue>(SqlStorageField<TEntity, TValue> field, ComparisonOperator comparisonType, TValue value);
		...
		IWhereQueryBuilder<TEntity> OrWhere<TValue>(SqlStorageField<TEntity, TValue> field, ComparisonOperator comparisonType, TValue value);
	}
}
